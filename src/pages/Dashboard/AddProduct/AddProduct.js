...
const AddProduct = () => {
    ...
    const handleAddProducts = (e) => {
        ...
        const catagory_slug = form.catagoryId.value;
    ...
    return (
        <section className="max-w-4xl my-4 sm:my-8 md:my-10 lg:my-12 p-6 mx-auto bg-white rounded-md shadow-md dark:bg-gray-800">
